...
fun Sources(newsManager: NewsManager) {
    val items = mapOf(
        ...
        "the-verge" to "TheVerge"
    )
    Scaffold(topBar = {
        TopAppBar(title = { Text(text = "${items[newsManager.sourceName.value] ?: ""} Source") },
            actions = {
                    ...
                    DropdownMenu(
                        ...
                        items.forEach {
                            DropdownMenuItem(onClick = {
                                newsManager.sourceName.value = it.key
                                menuExpanded = false
                            }) {
                                Text(it.value)
                            }
        ...
        Text(text = "e", modifier = Modifier.padding(it))
    }
}
